                        ...
                        <div class="invoice overflow-auto">
                            <div>
                                ...
                                <table id="info-table" style="margin-top: 10px;">
                                    ...
                                    <tr><td width="20%"><b>From Warehouse</b></td><td width="5%"><b>:</b></td><td>{{ $transfer->from_warehouse->name }}</td></tr>
                                    <tr><td width="20%"><b>To Warehouse</b></td><td width="5%"><b>:</b></td><td>{{ $transfer->to_warehouse->name }}</td></tr>
                                    <tr><td width="20%"><b>Transfer Date</b></td><td width="5%"><b>:</b></td><td>{{ date('d-M-Y',strtotime($transfer->transfer_date)) }}</td></tr>
                                    <tr><td width="20%"><b>Created By</b></td><td width="5%"><b>:</b></td><td>{{ $transfer->creator->name }}</td></tr>
                                </table>
                                <table border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tbody>
                                        @if (!$transfer->transfer_materials->isEmpty())
                                            @foreach ($transfer->transfer_materials as $key => $item)
                                                @php
                                                    $unit_name = '';
                                                    if($item->pivot->transfer_unit_id)
                                                    {
                                                        $unit_name = DB::table('units')->where('id',$item->pivot->transfer_unit_id)->value('unit_name');
                                                    }
                                                @endphp
                                                <tr>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                @else 
                                                    {{ config('settings.currency_symbol') }} {{ number_format($transfer->total_cost,4,'.','') }}
                                                @endif
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                @else 
                                                    {{ config('settings.currency_symbol') }} {{ number_format($transfer->shipping_cost,4,'.','') }}
                                                @endif
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                @else 
                                                    {{ config('settings.currency_symbol') }} {{ number_format($transfer->grand_total,4,'.','') }}
                                                @endif
                                            </td>
                                        </tr>
                                    </tfoot>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <div class="font-size-10" style="width:250px;float:left;padding-top:75px;">
                                                <p style="margin:0;padding:0;">{{ $transfer->received_by }}<br> {{ date('d-M-Y',strtotime($transfer->transfer_date)) }}</p>
                                                <p class="dashed-border"></p>
                                                <p style="margin:0;padding:0;font-weight:normal;">Received By</p>
                                            </div>
                                        </td>

                                        <td class="text-center">
                                            <div class="font-size-10" style="width:250px;float:right;">
                                                <p style="margin:35px 0 0 0;padding:0;font-weight:normal;">{{ $transfer->carried_by }}<br> {{ date('d-M-Y',strtotime($transfer->transfer_date)) }}</p>
                                                <p class="dashed-border"></p>
                                                <p style="margin:0;padding:0;font-weight:normal;">Carried By</p>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
