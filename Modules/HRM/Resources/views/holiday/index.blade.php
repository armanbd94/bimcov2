        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="javascript:void(0);" onclick="showFormModal('Add New Holiday','Save')" class="btn btn-primary btn-sm font-weight-bolder"> 
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        <x-form.textbox labelName="Holiday Name" name="name" col="col-md-4" />
                        <div class="col-md-8">
...
<script>
    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url = "{{route('holiday.store.or.update')}}";
        ...
        function multi_delete(){
            ...
            if(ids.length == 0){
                ...
                let url = "{{route('holiday.bulk.delete')}}";
