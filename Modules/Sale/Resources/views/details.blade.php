                            ...
                            <div>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td width="50%" class="text-right">
                                            <h4 class="name m-0">Invoice No: #{{ $sale->invoice_no }}</h4>
                                            <div class="m-0 date"><b>Invoice Date: </b>{{ date('d-M-Y',strtotime($sale->sale_date)) }}</div>
                                            <div class="m-0 date"><b>Delivery Status: </b>{{ $sale->delivery_status ? DELIVERY_STATUS[$sale->delivery_status] : 'N/A' }}</div>
                                            <div class="m-0 date"><b>Delivery Date:</b>{{ $sale->delivery_date ? date('d-M-Y',strtotime($sale->delivery_date)) : 'N/A' }}</div>
                                            <div class="m-0 date"><b>MO ID: </b>{{ $sale->creator->id }}</div>
                                            <div class="m-0 date"><b>MO NAME: </b>{{ $sale->creator->name }}</div>
                                            <div class="m-0 date"><b>Work Order No.: </b>{{ $sale->work_order_no }}</div>
                                ...
                                <table border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tfoot>
                                        ...
                                        {{-- <tr>
                                            <td colspan="4" class="text-left"><b>Driver Name:</b></td>
                                ...
                                <table>
                                    <tr>
                                        <td style="width: 180px;"><b>Amount (TK) In Word:</b> {{ numberTowords(($sale->grand_total + $sale->previous_due)) }}</td>
                                    </tr>
                                </table>
                                ...
                                <table border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">{{ number_format($item->grand_total,4,'.','') }}</td>
                                            <td class="text-right">{{ number_format($item->paid_amount,4,'.','') }}</td>
                                            <td class="text-right">{{ number_format(($item->grand_total - $item->paid_amount),4,'.','') }}</td>
                                        </tr>
                                            @php
                                                $total_net_amount += $item->grand_total;
                                                $total_paid_amount += $item->paid_amount;
                                                $total_due_amount += ($item->grand_total - $item->paid_amount);
                                            @endphp
                                        @endforeach
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th class="text-right">{{ number_format($total_net_amount,4,'.','') }}</th>
                                            <th class="text-right">{{ number_format($total_paid_amount,4,'.','') }}</th>
                                            <th class="text-right">{{ number_format($total_due_amount,4,'.','') }}</th>
                                        </tr>
                                    </tfoot>
                                </table>
                                @endif
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="font-size-10" style="width:250px;float:right;">
                                                <p style="margin:35px 0 0 0;padding:0;text-transform: capitalize;font-weight:normal;">{{ $sale->creator->name }}<br> {{ date('d-M-Y h:i:s A',strtotime($sale->created_at)) }}</p>
                                                <p class="dashed-border"></p>
