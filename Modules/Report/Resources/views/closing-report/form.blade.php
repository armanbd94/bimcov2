                                ...
                                <div class="card card-custom card-border">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="last_day_closing" id="last_day_closing" >
                                        </div>
                                        <div class="form-group">
                                            <label for="cash_in">Receive</label>
                                        ...
                                        <div class="form-group">
                                            <label for="cash_in_hand">Balance</label>
...
function closing_data()
{
    $.ajax({
        ...
        success: function (data) {
            $('#last_day_closing').val(data.last_day_closing);
            $('#cash_in').val(data.cash_in);
            $('#cash_out').val(data.cash_out);
            $('#cash_in_hand').val(data.cash_in_hand);
        },
