                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <table class="table table-borderless table-hover" id="materialTbl">
                                    <tr>
                                        <td><b>Batch No</b></td> <td class="text-center"><b>:</b></td> <td class="font-weight-bolder text-dark">{{ $production->batch_no }}</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><b>Mfg. Date</b></td> <td class="text-center"><b>:</b></td> <td>{{ date('j-F-Y',strtotime($production->mfg_date)) }}</td>
                                    </tr>
                                    <tr>
                                        <td><b>Exp. Date</b></td> <td class="text-center"><b>:</b></td> <td>{{ date('j-F-Y',strtotime($production->exp_date)) }}</td>
                                    ...
                                    <tr>
                                        <td><b>Finish Goods Warehouse</b></td> <td class="text-center"><b>:</b></td> <td>{{ $production->pwarehouse->name }}</td>
                                        <td><b>Material Warehouse</b></td> <td class="text-center"><b>:</b></td> <td>{{ $production->mwarehouse->name }}</td>
                                        <td><b>Approve Status</b></td> <td class="text-center"><b>:</b></td> <td>{{ APPROVE_STATUS[$production->status] }}</td>
                                    </tr>
                                    <tr>
                                        <td><b>Production Status</b></td> <td class="text-center"><b>:</b></td> <td>{{ PRODUCTION_STATUS[$production->production_status] }}</td>
