                                ...
                                <div class="col-12">
                                    ...
                                    {{-- <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" value="{{ config('settings.tax')}}" name="tax" id="tax">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="radio-inline">
                                            <label class="radio">
                                            <input type="radio" {{ config('settings.tax_option') == '1' ? 'checked' : 'checked'}} name="tax_option" id="tax_option" value="1">
                                            <span></span>Inclusive</label>
                                            <label class="radio">
                                            <input type="radio" nname="tax_option" id="tax_option" {{ config('settings.tax_option') == '2' ? 'checked' : ''}} value="2">
                                            <span></span>Exclusive</label>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Vat</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" value="{{ config('settings.vat')}}" name="vat" id="vat">
                                            <div class="input-group-append">
                                                <span class="input-group-text bg-primary text-white">%</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="radio-inline">
                                            <label class="radio">
                                            <input type="radio" {{ config('settings.vat_option') == '1' ? 'checked' : 'checked'}} name="vat_option" id="vat_option" value="1">
                                            <span></span>Inclusive</label>
                                            <label class="radio">
                                            <input type="radio" name="vat_option" id="vat_option" {{ config('settings.vat_option') == '2' ? 'checked' : ''}} value="2">
                                            <span></span>Exclusive</label>
                                        </div>
                                    </div> --}}
                                    ...
                                    <x-form.textbox labelName="Invoice Prefix" name="invoice_prefix" value="{{ config('settings.invoice_prefix')}}" required="required" col="col-md-6" placeholder="Enter invoice prefix"/>
                                    <x-form.textbox labelName="Invoice Starting Number" name="invoice_number" value="{{ config('settings.invoice_number')}}" required="required" col="col-md-6" placeholder="Enter invoice starting number"/>
