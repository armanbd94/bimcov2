        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="{{ route('finish.goods.add') }}"  class="btn btn-primary btn-sm font-weight-bolder"> 
...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "buttons": [
                @if (permission('finish-goods-report'))
                {
        ...
        $(document).on('click', '.delete_data', function () {
            ...
            let url   = "{{ route('finish.goods.delete') }}";
        ...
        function multi_delete(){
            ...
            if(ids.length == 0){
                ...
                let url = "{{route('finish.goods.bulk.delete')}}";
        ...
        $(document).on('click', '.change_status', function () {
            ...
            let row    = table.row($(this).parent('tr'));
            let url    = "{{ route('finish.goods.change.status') }}";
