                    ...
                    <form id="purchase_return_form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3 required">
                                ...
                                <input type="text" class="form-control" name="invoice_no" id="invoice_no" value="{{ $purchase->invoice_no }}"  readonly />
                            </div>
                            <div class="form-group col-md-3 required">
                            ...
                            <div class="form-group col-md-3 required">
                                ...
                                <input type="text" class="form-control" name="warehouse_name" id="warehouse_name" value="{{ $purchase->warehouse->name }}" readonly />
