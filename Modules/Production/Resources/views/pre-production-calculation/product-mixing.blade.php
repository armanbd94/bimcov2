                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group col-md-12 required">
                                                <label for="product_id">Finish Goods</label>
                                                <input type="text" class="form-control" value="{{ $production->product->code.' - '.$production->product->name }}"  readonly />
                                            ...
                                            <div class="form-group col-md-12 required">
                                                <label for="formulation_no">FG Serial No</label>
                                                <input type="text" class="form-control" value="{{ $production->formulation->formulation_no }}" readonly />
                                                <input type="hidden" class="form-control" name="formulation_no" id="formulation_no" value="{{ $production->formulation_id }}" readonly />
                                            </div>
                                            <div class="col-md-12">
                                                <div class="row" style="justify-content: space-evenly;">
                                                    <button type="button" class="btn btn-sm btn-success col-md-5" id="active-btn" onclick="showFormulationData('active','{{ $production->product_id }}',' {{ $production->formulation_id }}')">Show Active FG SL</button>
                                                    <button type="button" class="btn btn-sm btn-secondary col-md-5" id="all-btn" onclick="showFormulationData('all','{{ $production->product_id }}',' {{ $production->formulation_id }}')">Show All FG SL</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group col-md-12 required">
                                                ...
                                                <input type="text" class="form-control" name="reference_no" id="reference_no" value="{{ $production->serial_no }}" readonly />
                                            </div>
                                            <div class="form-group col-md-12 required">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group col-md-12 required">
                                                ...
                                                <input type="text" class="form-control" name="total_fg_qty" id="total_fg_qty" value="{{ $production->total_fg_qty }}" readonly />
                                            </div>
...
function showFormulationData(type,product_id,formulation_no)
{
    if(product_id && formulation_no)
    {
        $.ajax({
...
function store_data(){
    let form = document.getElementById('store_or_update_form');
    let formData = new FormData(form);
    let url = "{{url('pre-production-product-mixing/store')}}";
    $.ajax({
        url: url,
        type: "POST",
        data: formData,
