...
class SalaryGeneratePaymentController extends Controller
{
    ...
    private function payment_balance_add(array $data) {
        //dd($data);
        $voucher_type = 'Salary Expense';
        // customer Debit
        $expense_acc = array(
            'chart_of_account_id' => $data['expense_salary_coa_id'],
        ...
        //$expense_transaction = Transaction::create([$expense_acc]);
        //$expense_transaction = Transaction::updateOrCreate(['id'=> $data['employee_transaction_id']],$expense_acc);
        $payment_transaction        = Transaction::updateOrCreate(['id'=> $data['transaction_id']],$payment);
         ...
         if($payment_transaction){
             ...
             //dd($payment_data);
            //$result = SalaryGeneratePayment::updateOrCreate(['id'=>$data['payment_id']],$payment_data);
            //$result = SalaryGeneratePayment::insert($payment_data);
            $result =1;
            return $result;
         }
