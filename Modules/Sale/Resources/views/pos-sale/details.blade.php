                    ...
                    <div id="invoice">
                        ...
                        <div class="invoice overflow-auto">
                            <div>
                                ...
                                <table>
                                    <tr>
                                        <td style="width: 180px;"><b>Amount (TK) In Word:</b> {{ numberTowords(($sale->grand_total)) }}</td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="font-size-10" style="width:250px;float:right;">
                                                <p style="margin:35px 0 0 0;padding:0;"><b class="text-uppercase">{{ $sale->creator->name }}</b><br> {{ date('d-M-Y h:i:s A',strtotime($sale->created_at)) }}</p>
                                                <p class="dashed-border"></p>
