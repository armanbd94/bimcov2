        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="javascript:void(0);" onclick="showFormModal('Add New Shift','Save')" class="btn btn-primary btn-sm font-weight-bolder"> 
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        <x-form.textbox labelName="shift Name" name="name" col="col-md-4" />
                        <div class="col-md-8">
...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{route('shift.datatable.data')}}",
                "type": "POST",
                "data": function (data) {
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url = "{{route('shift.store.or.update')}}";
        ...
        function multi_delete(){
            ...
            if(ids.length == 0){
                ...
                let url = "{{route('shift.bulk.delete')}}";
        ...
        $(document).on('click', '.change_status', function () {
            ...
            let row    = table.row($(this).parent('tr'));
            let url    = "{{ route('shift.change.status') }}";
