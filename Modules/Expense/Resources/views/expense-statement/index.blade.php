...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{route('expense.statement.datatable.data')}}",
                "type": "POST",
                "data": function (data) {
            ...
            "buttons": [
                ...
                },
                {
                    ...
                    "title": "{{ $page_title }} List<br>"+$("#form-filter #start_date").val()+' TO '+$("#form-filter #end_date").val(),
            ...
            "footerCallback": function ( row, data, start, end, display ) {
                ...
                // Total over all pages
                    ...
                    // Update footer
                    $( api.column( 4 ).footer() ).html('= '+number_format(pageTotal));
