                            ...
                            <div>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td width="50%" class="text-right">
                                            <h4 class="name m-0">#{{ $purchase->invoice_no }}</h4>
                                ...
                                <table border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tfoot>
                                        ...
                                        {{-- <tr>
                                            <td colspan="4" class="text-left"><b>Vehicle No.:</b></td>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <div class="font-size-10" style="width:250px;float:left;padding-top:75px;">
                                                <p style="margin:0;padding:0;"><b class="text-uppercase"></p>
                                                <p class="dashed-border"></p>
                                                <p style="margin:0;padding:0;text-transform: capitalize;font-weight:normal;">Supplier Signature & Date</p>
                                            </div>
                                        </td>

                                        <td class="text-center">
                                            <div class="font-size-10" style="width:250px;float:right;">
                                                <p style="margin:35px 0 0 0;padding:0;text-transform: capitalize;font-weight:normal;">{{ $purchase->creator->name }}<br> {{ date('d-M-Y h:i:s A',strtotime($purchase->created_at)) }}</p>
                                                <p class="dashed-border"></p>
