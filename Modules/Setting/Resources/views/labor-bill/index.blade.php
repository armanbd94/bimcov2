...
@include('setting::labor-bill.modal')
@endsection
...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{route('labor.bill.datatable.data')}}",
                "type": "POST",
                "data": function (data) {
            ...
            "buttons": [
                @if (permission('labor-bill-report'))
                {
        ...
        $('#btn-reset').click(function () {
         ...
         $(document).on('click', '#save-btn', function () {
             ...
             let url = "{{route('labor.bill.store.or.update')}}";
         ...
         $(document).on('click', '.delete_data', function () {
             ...
             let url   = "{{ route('labor.bill.delete') }}";
             Swal.fire({
         ...
         function multi_delete(){
             ...
             if(ids.length == 0){
                 ...
                 let url = "{{route('labor.bill.bulk.delete')}}";
                 Swal.fire({
