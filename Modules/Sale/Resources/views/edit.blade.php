                    ...
                    <form id="sale_update_form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 required">
                                ...
                                <input type="text" class="form-control" name="work_order_no" id="work_order_no" value="{{ $sale->work_order_no }}"  />
                            </div>
                            ...
                            <div class="col-md-12">
                                <table class="table table-bordered" id="product_table">
                                        ...
                                        @if (!$sale->sale_products->isEmpty())
                                            @foreach ($sale->sale_products as $key => $sale_product)
                                                <tr>
                                                    ...
                                                    <td class="discount text-right d-none">{{ number_format((float)$sale_product->pivot->discount, 2, '.','') }}</td>
                                                    <td class="tax text-right d-none">{{ number_format((float)$sale_product->pivot->tax, 2, '.','') }}</td>
                                    ...
                                    <tfoot class="bg-primary">
                                        ...
                                        <th></th>
                                        <th id="total-discount" class="text-right font-weight-bolder d-none">{{ number_format($sale->total_discount,2,'.',',') }}</th>
                                        <th id="total-tax" class="text-right font-weight-bolder d-none">{{ number_format($sale->total_tax,2,'.',',') }}</th>
                            ...
                            <x-form.selectbox labelName="Receive Status" name="payment_status" required="required"  col="col-md-3" class="selectpicker">
                            ...
                            <div class="col-md-12">
                                <table class="table table-bordered">
                                    <thead class="bg-primary">
                                        ...
                                        <th class="d-none"><strong>Order Tax</strong><span class="float-right" id="order_total_tax">0.00</span></th>
                                        <th class="d-none"><strong>Order Discount</strong><span class="float-right" id="order_total_discount">0.00</span></th>
                            ...
                            <div class="payment col-md-12 @if($sale->payment_status == 3) d-none @endif">
                                <div class="row">
                                    ...
                                    <x-form.selectbox labelName="Receive Method" name="payment_method" onchange="account_list(this.value)" required="required"  col="col-md-3" class="selectpicker">
