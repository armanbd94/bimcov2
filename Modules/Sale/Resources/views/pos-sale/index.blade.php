        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Button-->
                    <a href="{{ route('pos.sale.add') }}"  class="btn btn-primary btn-sm font-weight-bolder"> 
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('pos.sale.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
    ...
    function multi_delete(){
        ...
        if(ids.length == 0){
            ...
            let url = "{{route('pos.sale.bulk.delete')}}";
