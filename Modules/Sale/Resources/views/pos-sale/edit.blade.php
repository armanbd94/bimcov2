                            ...
                            <div class="col-md-12">
                                <table class="table table-bordered">
                                    <thead class="bg-primary">
                                        ...
                                        <th class="d-none"><strong>Shipping Cost</strong><span class="float-right" id="shipping_total_cost">0.00</span></th>
            ...
            success: function (data) {
                ...
                if (data.status == false) {
                    ...
                    if (data.status == 'success') {
                        window.location.replace("{{ route('pos.sale') }}");
