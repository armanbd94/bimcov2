            ...
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        ...
                        <x-form.selectbox labelName="From Warehouse" name="from_warehouse_id" col="col-md-4" class="selectpicker">
                        ...
                        <x-form.selectbox labelName="To Warehouse" name="to_warehouse_id" col="col-md-4" class="selectpicker">
                            @if (!$warehouses->isEmpty())
                                @foreach ($warehouses as $warehouse)
                                    <option value="{{ $warehouse->id }}">{{ $warehouse->name }}</option>
                                @endforeach
